...
### v0.4.5
- 설정 창을 닫을 때 애니메이션 없이 즉시 사라지던 문제를 수정했습니다.
- OS의 '동작 줄이기' 설정을 켠 사용자를 위해 `prefers-reduced-motion`을 지원하여 애니메이션을 최소화합니다.
...
- 동기화 설정의 비밀번호 항목이 글자를 칠 때마자가 아니라 입력을 마치고 필드를 벗어날 때 저장됩니다.
